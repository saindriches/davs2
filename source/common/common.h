...
enum dct_pattern_e {
    DCT_DEAULT,      /* default */
    DCT_HALF,        /* ���ο�����Ͻ�1/2��ߣ����1/4���� �Ƿ��ο�Ϊ���Ͻ�1/2�����1/2�� */
    DCT_QUAD,        /* ���ο�����Ͻ�1/4��ߣ����1/16�����Ƿ��ο�Ϊ���Ͻ�1/4�����1/4�� */
...
typedef struct alf_param_t {
    ...
    int         coeffmulti[ALF_NUM_VARS][ALF_MAX_NUM_COEF];  // ���ȷ���16�ף�ɫ�ȷ�����1��
} alf_param_t;
...
typedef struct runlevel_t {
    ALIGN32(runlevel_pair_t  run_level[16]);     /* ���任ϵ����Ϊ32x32 */
...
#if SYS_WINDOWS
    LARGE_INTEGER nFreq;
    if (QueryPerformanceFrequency(&nFreq)) { // ���ط����ʾӲ��֧�ָ߾��ȼ�����
        LARGE_INTEGER t1;
