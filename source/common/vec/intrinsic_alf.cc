                             ...
                             int *alf_coeff, int b_top_avail, int b_down_avail)
{
    ...
    for (y = 0; y <= lcu_height; y++) {
        ...
        for (x = 0; x < lcu_width; x += 16) {
            ...
            S00 = _mm_maddubs_epi16(E00, C0);//ǰ8����������C0*P0�Ľ��
            S01 = _mm_maddubs_epi16(E01, C0);//��8����������C0*P0�Ľ��
            ...
            S10 = _mm_maddubs_epi16(E10, C1);//ǰ8����������C1*P1�Ľ��
            S11 = _mm_maddubs_epi16(E11, C1);//��8����������C1*P1�Ľ��
