...
void idct_8x8_sse128(const coeff_t *src, coeff_t *dst, int i_dst)
{
    ...
    S0 = _mm_packs_epi32(_mm_srai_epi32(_mm_add_epi32(E0l, O0l), 5), _mm_srai_epi32(_mm_add_epi32(E0h, O0h), 5));  // �״η��任��λ��
...
void idct_32x8_sse128(const coeff_t *src, coeff_t *dst, int i_dst)
{
    ...
    for (pass = 0; pass < 4; pass++) {
        ...
        m128iS0[pass] = _mm_packs_epi32(_mm_srai_epi32(_mm_add_epi32(E0l, O0l), 5), _mm_srai_epi32(_mm_add_epi32(E0h, O0h), 5));    // �״η��任��λ��
...
#define TRANSPOSE_8x8_16BIT(I0, I1, I2, I3, I4, I5, I6, I7, O0, O1, O2, O3, O4, O5, O6, O7) \
    ...
    //clip
    {
        ...
        for (pass = 0; pass < 4; pass++) {
            ...
            in00 = _mm_packs_epi32(_mm_srai_epi32(_mm_add_epi32(E0l, O0l), nShift), _mm_srai_epi32(_mm_add_epi32(E0h, O0h), nShift));     // �״η��任��λ��
